...
Describe 'Action parameter "module-to-cache" or "module-to-cache-prerelease". When there is no error.' -Tag 'KeyGen' {
...
Describe 'Action parameter "module-to-cache" or "module-to-cache-prerelease". When there error.' -Tag 'KeyGen' {

  Context "Invalid syntax for 'module-to-cache' or 'module-to-cache-prerelease' parameter" {
    it "Invalid file name 'EmptyCredentialFileName'." {
      $Err={ New-ModuleCacheParameter -RepositoriesAuthenticationFileName '' -UseRepositoriesWithCredential}|Should -Throw -PassThru
      $Err.Exception.Message | Should -Be  $global:PSModuleCacheResources.EmptyCredentialFileName

      $Err={ New-ModuleCacheParameter -UseRepositoriesWithCredential }|Should -Throw -PassThru
      $Err.Exception.Message | Should -Be  $global:PSModuleCacheResources.EmptyCredentialFileName
    }
