#
# Manifeste de module pour le module « DuplicateByDependency »
#
# Généré par : Laurent
#
# Généré le : 19/052/2023
#

@{

    # Module de script ou fichier de module binaire associé à ce manifeste
    RootModule        = 'DuplicateByDependency'
    ...
    GUID              = 'f1526da5-7676-44f0-864f-bddb62500843'
    ...
    Description       = 'Module DuplicateByDependency'
    ...
    RequiredModules   = @(@{ModuleName = 'Main'; RequiredVersion = '1.0.0' ; GUID = '749ed353-19c8-4d42-9933-3023018d6b01' })
