#
# Manifeste de module pour le module « External »
#
# Généré par : Laurent
#
# Généré le : 11/03/2023
#
...
@{
    ...
    GUID              = '134dc329-51f6-44b4-a7c2-c1abed478017'
    ...
    Description       = 'Module external module dependncy'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ExternalModuleDependencies = @('UnknownModule')
