#
# Manifeste de module pour le module « DependOfWrongnaming »
#
# Généré par : Laurent
#
# Généré le : 29/08/2023
#

@{

# Module de script ou fichier de module binaire associé à ce manifeste
RootModule = 'DependOfWrongnaming'
...
GUID = '0b232b7d-8388-4bd3-ad33-ab66c7504d51'
...
Copyright = '(c) 2023 Laurent. Tous droits réservés.'

# Description de la fonctionnalité fournie par ce module
Description = 'Module DependOfWrongnaming'
...
RequiredModules   = @( @{ ModuleName = 'WrongNamingRule'; RequiredVersion = '1.0.0'; Guid = '9d3c3b12-fd2c-47b9-bee0-9fc92c521e72' } )
