#
# Manifeste de module pour le module « Duplicate »
#
# Généré par : Laurent
#
...
@{
    ...
    GUID              = '320b6974-dfcb-4508-a5fe-81a0d554b157'
    ...
    RequiredModules   = @(@{ModuleName = 'String'; RequiredVersion = '1.0.0' ; GUID = '2cf44dd1-fdc0-4df7-a992-27cd359b08aa' })
