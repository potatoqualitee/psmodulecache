#
# Manifeste de module pour le module « Main »
#
# Généré par : Laurent
#
...
@{
    ...
    GUID              = '749ed353-19c8-4d42-9933-3023018d6b01'
    ...
    RequiredModules   = @(@{ModuleName = 'Duplicate'; ModuleVersion = '1.0.0'; GUID = '2cf44dd1-fdc0-4df7-a992-27cd359b08aa' })
