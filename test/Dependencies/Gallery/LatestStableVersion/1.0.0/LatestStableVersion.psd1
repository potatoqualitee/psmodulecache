#
# Manifeste de module pour le module « LatestStableVersion »
#
# Généré par : Laurent
#
# Généré le : 19/08/2023
#

@{

    # Module de script ou fichier de module binaire associé à ce manifeste
    RootModule        = 'LatestStableVersion'
    ...
    GUID              = '9f869a68-ecb4-44de-ab69-71fe571da416'
    ...
    Description       = 'Module LatestPreleaseVersion'
    ...
    RequiredModules   = @(@{ ModuleName = "UpperCase"; ModuleVersion = "1.0.0" ; GUID = "0dddb402-8080-439d-a5a0-06511fd76e7e" })
