#
# Manifeste de module pour le module « Depends »
#
# Généré par : Laurent
#
...
@{
    ...
    GUID              = 'cc9919ea-5d1e-49bd-b7d6-a0f4d4b4a3ec'
    ...
    RequiredModules   = @( @{ ModuleName = 'Tools'; RequiredVersion = '1.0.0'; Guid = '07571b28-ccde-4508-a55f-add334da649b' } )
