#
# Manifeste de module pour le module « String »
#
# Généré par : Laurent
#
# Généré le : 18/08/2023
#
...
@{
    ...
    GUID              = '2cf44dd1-fdc0-4df7-a992-27cd359b08aa'
    ...
    Description       = 'Module String with MaximumVersion'
    ...
    RequiredModules   = @(@{ ModuleName = 'UpperCase'; ModuleVersion = '1.0.0' ; GUID = '0dddb402-8080-439d-a5a0-06511fd76e7e' ; MaximumVersion='3.0.0'})
