...
@{
    ...
    Description       = 'Module String with lowercase dependencies'
    ...
    RequiredModules   = @(@{ ModuleName = 'lowercase'; ModuleVersion = '2.0.0' ; GUID = '15999f90-c71b-473c-b08f-07fb36c01d1c' })
