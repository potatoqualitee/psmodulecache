#
# Manifeste de module pour le module « DependNotExist »
#
# Généré par : Laurent
#
# Généré le : 10/02/2023
#

@{

# Module de script ou fichier de module binaire associé à ce manifeste
RootModule = 'GuidNotExist'
...
GUID = '933a1fae-97d9-4e37-975f-dceb8c872b20'
...
# le GUID n'existe pas
RequiredModules = @(@{ModuleName = 'String';ModuleVersion = '1.0.0'; Guid ='2cf44dd1-fdc0-1234-a992-27cd359b08aa'})
